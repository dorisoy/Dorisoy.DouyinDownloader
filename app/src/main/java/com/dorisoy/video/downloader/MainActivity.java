...
import com.dorisoy.video.downloader.content.Recv;
import com.dorisoy.video.downloader.core.app.BaseActivity;
import com.dorisoy.video.downloader.core.content.ClipboardManager;
import com.dorisoy.video.downloader.layout.fragment.DownloadTaskFragment;
import com.dorisoy.video.downloader.layout.fragment.HistoryFragment;
import com.dorisoy.video.downloader.layout.fragment.VideoFragment;
import com.dorisoy.video.downloader.layout.fragment.VideoSearchFragment;
    ...
    public void onBackPressed() {
        ...
        if (fm.getBackStackEntryCount() == 0 && !fromSend) {
            if (backPressAt == null || new Date().getTime() - backPressAt.getTime() > 2000) {
                ...
                com.dorisoy.video.downloader.core.app.Process.background(this);
                //super.onBackPressed();
                return;
            }
        }
